...
class _CreditScreenState extends State<CreditScreen> {
  ...
  void gitHub() async {
    const url = 'https://github.com/apesin/covid19';
  ...
  void visitSite() async {
    const url = 'http://apesin.tech';
    if (await canLaunch(url)) {
      await launch(url, forceSafariVC: false,);
    } else {
      throw 'Could not launch $url';
            ...
            children: <Widget>[
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Text(" by "),
                  Text("Niniola Adesina",style: TextStyle(fontWeight: FontWeight.bold),),
